              ...
              <div class="d-flex justify-content-between mb-2">
                <div>
                  <a href="{{ route('admin.appointments.create') }}">
                    <button class="btn btn-primary"><i class="fa fa-plus-circle mr-2"></i> Add New Appointment</button>
                  </a>
                  ...
                  <div class="btn-group ml-2">
                    ...
                    <div class="dropdown-menu" role="menu">
                      ...
                      <a wire:click.prevent="exportExcel" class="dropdown-item" href="#">Export Excel</a>
                    </div>
                  </div>
